...
<header class="bg-white shadow-lg">
    <div class="container mx-auto px-4 py-2 flex items-center justify-between">
        <h1 class="text-lg font-bold"><a href="{{ route('homes') }}" class="text-gray-600 hover:text-gray-800">Events+</a></h1>
        <nav>
            <ul class="flex space-x-4">
                <li><a href="{{ route('homes') }}" class="text-gray-600 hover:text-gray-800">Home</a></li>
